...
import 'package:servemandu_partner/mainScreens/service_providing_screen.dart';
...
class ShipmentAddressDesign extends StatelessWidget
{
  ...
  confirmedParcelShipment(BuildContext context, String getOrderID, String sellerId, String purchaserId)
  {
    ...
    Navigator.push(context, MaterialPageRoute(builder: (context) => ServiceProvidingScreen(
          ...
          child: Center(
            child: InkWell(
              ...
              child: Container(
                ...
                child: const Center(
                  child: Text(
                    "Confirm - To Deliver this Service",
